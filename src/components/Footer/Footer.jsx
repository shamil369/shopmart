    ...
    <footer className='bg-blue-950 py-24 text-white'>
        <div className='max-w-full px-5 grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-4 '>
          <div className='box p-1'>
            <div className='mb-6 '>
                <img className="inline bg-blue-950" src="/shopNewLogo.jpg" width="50px"  alt="Logo"/>
            ...
            <p className='text-sm font-light opacity-60 mb-5'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Auctor libero id et, in gravida. Sit diam duis mauris nulla cursus. Erat et lectus vel ut sollicitudin elit at amet.</p>
          ...
          <div className='box p-1'>
            <h2 className='mb-5 mt-1 font-semibold text-xl lg:text-3xl'>Customer Care</h2>
            <ul>
              <li>Help Center </li>
              <li>How to Buy </li>
          ...
          <div className='box p-1'>
            <h2 className='mb-5 mt-1 font-semibold text-xl lg:text-3xl'>Contact Us</h2>
            <ul>
